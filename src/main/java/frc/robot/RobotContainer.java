...
public class RobotContainer {
  ...
  private final CommandXboxController driverController = new CommandXboxController(DRIVER_CONTROLLER);

  private final CommandXboxController auxController = new CommandXboxController(AUX_CONTROLLER);
  ...
  private void configureBindings() {
    ...
    driverController.leftBumper().onTrue(new CmdShiftGear(subDriveTrain));
